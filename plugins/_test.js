...
author = author || 'no encontrado'
    ...
    if (command === 'playx' || command === 'yta' || command === 'ytmp3' || command === 'playaudio') {
      try {
    ...
    } else if (command === 'play2x' || command === 'ytv' || command === 'ytmp4' || command === 'mp4') {
      try {
...
handler.command = handler.help = ['playx', 'yta', 'ytmp3', 'play2x', 'ytv', 'ytmp4', 'playaudio', 'mp4']
