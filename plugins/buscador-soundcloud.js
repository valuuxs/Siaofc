...
if (!text) return conn.reply(m.chat, `*[ 🧃 ] Ingresa el texto de la cancion que quieras buscar en SoundCloud*`, m, fkontak)
...
handler.command = ['scsearch', 'soundcloudsearch', 'soundsearch']
