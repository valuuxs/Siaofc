...
if (chat.welcome && m.messageStubType == 28) {
  ...
  let expulsado = chat.sKick
    ? chat.sKick
        .replace(/@user/g, taguser)
        .replace(/@group/g, groupName)
        .replace(/@desc/g, groupDesc)
        .replace(/@count/g, groupSize)
    : `*¡Expulsado!*\n෫ࣲׄ֟፝͡${taguser} 👊🏻꒱\n\nᏊ⁠ 𝖴𝗇 𝗇𝖾𝗀𝗋𝗈 𝗆𝖾𝗇𝗈𝗌 𝖾𝗇 𝖾𝗅 𝗀𝗋𝗎𝗉𝗈, 𝗉𝗈𝗋 𝗇𝗈 𝗈𝖻𝖾𝖽𝖾𝖼𝖾𝗋 𝗅𝖺𝗌 𝗋𝖾𝗀𝗅𝖺𝗌.\n ׅ⿻ 𝖮𝗃𝖺𝗅𝖺 𝗒 𝗅𝖺 𝖾𝗅𝗂𝗆𝗂𝗇𝖺𝖼𝗂𝗈𝗇 𝗅𝖾 𝗁𝖺𝗀𝖺 𝗋𝖾𝖿𝗅𝗂𝗃𝗂𝗈𝗇𝖺𝗋 𝗑𝖣\n\n> ${dev}`

  await conn.sendLuffy(m.chat, txt1, sunflare1, expulsado, img, img, insta, fkontak)
}
...
if (chat.welcome && m.messageStubType == 32) {
  ...
  await conn.sendLuffy(m.chat, txt1, sunflare2, salida, img, img, insta, fkontak)
}