...
if (chat.welcome && m.messageStubType == 27) {
  ...
  await conn.sendBot(m.chat, txt, sunflare, bienvenida, img, img, insta, fkontak)
}
...
if (chat.welcome && m.messageStubType == 28) {
  ...
  let ban = chat.sKick
    ...
    await conn.sendBot(m.chat, txt1, sunflare1, ban, img, img, insta, fkontak)
  }
...
if (chat.welcome && m.messageStubType == 32) {
  ...
  let bye = chat.sBye
    ...
    await conn.sendBot(m.chat, txt1, sunflare2, bye, img, img, insta, fkontak)
  }}