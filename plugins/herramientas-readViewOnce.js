...
if (!m.quoted) return conn.reply(m.chat, `*🍃 Por favor, responde a una imagen ViewOnce (ver solo vez)*.`, m)
if (!m?.quoted || !m?.quoted?.viewOnce) return conn.reply(m.chat, `*🍃 Responde a una imagen ViewOnce (ver solo una vez)*`, m)
