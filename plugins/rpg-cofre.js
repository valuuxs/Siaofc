const handler = async (m, {isPrems, conn}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastcofre < 86400000) return conn.reply(m.chat, `🎁 Ya Reclamastes Tu Cofre\n⏰️Regresa En: \`${msToTime(time - new Date())}\` Para Volver A Reclamar`, m);
