...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  if (room == undefined) return conn.sendButton(m.chat, `*${xgame} No estas en ninguna partida de tres en raya.*`, wm, null, [['Iniciar sala de juego', `${usedPrefix}ttt partida nueva`]], m);
