...
global.authFile = global.sessions
global.authFileJB  = global.jadi
...
const subBotDirectory = global.authFileJB
if (!existsSync(subBotDirectory)) {
console.log(`${global.botname} no tiene Sub-Bots vinculados.`);
return;
}
...
console.log(chalk.bold.greenBright(`☁️ ${global.botname} conectado correctamente.`))
...
const directories = [`./${global.authFile}/`, `./${global.authFileJB}/`]
